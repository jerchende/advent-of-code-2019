...
class IntCodeProgrammTest {
    ...
    void shouldRunProgramm(String input, String output) {
        var intCodeProgramm = net.erchen.adventofcode2019.day05.IntCodeProgramm.fromInput(input);
    ...
    void shouldPassInputAndOutput() {
        var intCodeProgramm = net.erchen.adventofcode2019.day05.IntCodeProgramm.fromInput("3,0,4,0,99");
    ...
    void shouldRunDiagnosticProgramm() {
        var intCodeProgramm = net.erchen.adventofcode2019.day05.IntCodeProgramm.fromInput(solutionInput());
